...
public class Level1 extends BasicGameState {
    ...
    // bool for logs toggle, set to true to show logs:
    ...
    public void enter(GameContainer container, StateBasedGame game) {
        ...
        //levelMaps holds current, next and previous states of the level.levelMaps = new MapUtil();
        // grab the map we want to use for this level from MapUtil.
        initializeLevel(1);
        levelMaps.currentMap = tileMap;
        levelMaps.printCurrentMap();
