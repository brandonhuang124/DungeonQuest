...
public class Player extends Entity {
     ...
     */
    public boolean isMoveValid(int direction, Vector movement, MapUtil levelMap) {
      boolean adjacencyCheck = false;
      Coordinate newPlayerPos = new Coordinate(worldPos.x + movement.getX(), worldPos.y + movement.getY());
      TileIndex newTile = MapUtil.convertWorldToTile(newPlayerPos);
      if(levelMap.currentTileMap[newTile.x][newTile.y].getID() == 1) {
        return false;
      }
      return true;
      /*
